...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyANXCRWNVXGCjjlyTwrRITX6yN3xPG84po";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvOverview = findViewById(R.id.overview_tv);
        ...
        ratingBar.setRating((float) movie.getRatingAverage());
        ...
        client.get(String.format(TRAILERS_API, movie.getMovieId()), new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    initializeYoutubeTrailer(trailerKey);
    ...
    private void initializeYoutubeTrailer(final String trailerKey) {
        youTubePlayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                Log.d("smile", "Initialization Success");
                youTubePlayer.cueVideo(trailerKey);
            }

            @Override
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Log.d("smile", "Initialization Failure");
            }
        });
    }
}
